...
def test_attribution_methods_with_2d_input_models():
    ...
    models = [
        ...
        SmallConv1DModel(input_channels=input_shape[1], input_length=input_shape[2]),
    ]
...
def test_attribution_methods_with_3d_input_models():
    ...
    models = [
        SmallConv2DModel(input_channels=input_shape[1], image_size=(input_shape[2], input_shape[3])),
        SmallViTModel(input_channels=input_shape[1], image_size=(input_shape[2], input_shape[3])),
    ]
